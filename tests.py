from main import Figure, KingFigure, QueenFigure, BishopFigure, RookFigure, KnightFigure, PawnFigure, ChessValid

class TestKingMoves:
    def test_move_in_range(self):
        k1 = KingFigure(4, 5)
        assert k1.list_allowed_moves() == [(5, 5), (3, 5), (4, 6), (4, 4), (5, 6), (3, 4), (3, 6), (5, 4)]
...
class TestQueenMoves:
    def test_move_in_range(self):
        k1 = QueenFigure(4, 5)
        assert k1.list_allowed_moves() == [(0, 1), (1, 2), (3, 4), (2, 7), (5, 4), (2, 3), (6, 7), (5, 6), (7, 2), (3, 6), (6, 3)]
...
class TestRookMoves:
    def test_move_in_range(self):
        k1 = RookFigure(4, 5)
        assert k1.list_allowed_moves() == [(4, 0), (4, 1), (4, 2), (4, 3), (4, 4), (4, 6), (4, 7), (0, 5), (1, 5), (2, 5), (3, 5), (5, 5), (6, 5), (7, 5)]
...
class TestKnightMoves:
    def test_move_in_range(self):
        k1 = KnightFigure(4, 5)
        assert k1.list_allowed_moves() == [(6, 6), (5, 7), (3, 7), (2, 6), (2, 4), (3, 3), (5, 3), (6, 4)]
